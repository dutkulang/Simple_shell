 ...
 * Description - parse_command, determines the type of the command
 * Description - EXTERNAL_COMMAND (1) represents commands like /bin/ls
 * Description - INTERNAL_COMMAND (2) represents commands like exit, env
 * Description - PATH_COMMAND (3) represents commands found in the PATH like ls
 * Description - INVALID_COMMAND (-1) represents invalid commands
